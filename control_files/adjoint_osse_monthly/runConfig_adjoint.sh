...
#    Initial restart file
#------------------------------------------------
INITIAL_RESTART=gcchem_internal_restart.20190111_000000z.nc4
#
...
replace_val SFEmissions.backwards 1 HISTORY.rc
...
replace_val REVERSE_TIME "1"          CAP.rc
